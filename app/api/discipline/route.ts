  ...
  try {
    ...
    const entry = await prisma.disciplineEntry.create({
      data: {
        ...
        exerciseDuration: exerciseDuration ? parseInt(exerciseDuration, 10) : 0,
        productiveHours: productiveHours ? parseInt(productiveHours, 10) : 0,
        distractionsResisted: distractionsResisted ? parseInt(distractionsResisted, 10) : 0,
        promisesKept: promisesKept ? parseInt(promisesKept, 10) : 0,
        selfRating: selfRating ? parseInt(selfRating, 10) : 5,
